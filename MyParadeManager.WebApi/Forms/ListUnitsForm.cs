...
public class ListUnitsForm : AutoCleanForm
{
    private readonly IServiceProvider _serviceProvider;

    public ListUnitsForm(IServiceProvider serviceProvider)
    {
    ...
    public override async Task Render(MessageResult message)
    {
        ...
        // var teams = (await ctx.GetUnitAsync()).ToImmutableList();
    ...
    public override async Task Action(MessageResult message)
    {
        ...
        switch (data.Value)
        {
            ...
            default:
                await this.NavigateTo<UnitOverviewForm>(data.Value);
                break;
        }
    }
}